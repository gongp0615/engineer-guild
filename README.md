...
- [1. 全局架构 — Claude Code 的分层设计](#1-全局架构--claude-code-的分层设计)
  - [1.1 分层设计总览](#11-分层设计总览)
  - [1.2 全局架构图](#12-全局架构图)
  - [1.3 各层职责](#13-各层职责)
  - [1.4 设计哲学](#14-设计哲学)
- [2. Agent 引擎 — 核心决策循环](#2-agent-引擎--核心决策循环)
  - [2.1 Agent Loop：核心循环](#21-agent-loop核心循环)
  - [2.2 上下文管理](#22-上下文管理)
  - [2.3 多 Agent 协作](#23-多-agent-协作)
- [3. Skill 系统 — 可扩展的能力模块](#3-skill-系统--可扩展的能力模块)
  - [3.1 Skill 是什么](#31-skill-是什么)
  - [3.2 Skill 的文件结构](#32-skill-的文件结构)
  - [3.3 Skill 的发现与加载](#33-skill-的发现与加载)
  - [3.4 自定义 Skill 实战](#34-自定义-skill-实战)
- [4. MCP 协议 — 连接外部世界](#4-mcp-协议--连接外部世界)
  - [4.1 MCP 是什么](#41-mcp-是什么)
  - [4.2 MCP 架构](#42-mcp-架构)
  - [4.3 MCP 三大原语](#43-mcp-三大原语)
  - [4.4 MCP 配置实战](#44-mcp-配置实战)
  - [4.5 设计权衡](#45-设计权衡)
- [5. Hooks 机制 — 事件驱动的自动化](#5-hooks-机制--事件驱动的自动化)
  - [5.1 Hooks 是什么](#51-hooks-是什么)
  - [5.2 Hooks 的配置](#52-hooks-的配置)
  - [5.3 实战场景](#53-实战场景)
  - [5.4 Hooks vs MCP Tools](#54-hooks-vs-mcp-tools)
- [6. Spec 规范 — 声明式配置驱动 Agent 行为](#6-spec-规范--声明式配置驱动-agent-行为)
  - [6.1 Spec 是什么](#61-spec-是什么)
  - [6.2 Spec 的层次结构](#62-spec-的层次结构)
  - [6.3 CLAUDE.md 示例](#63-claudemd-示例)
  - [6.4 Spec 与 Agent 的关系](#64-spec-与-agent-的关系)
- [7. Harness 运行时 — 安全与配置基础设施](#7-harness-运行时--安全与配置基础设施)
  - [7.1 Harness 的角色定位](#71-harness-的角色定位)
  - [7.2 权限模型](#72-权限模型)
  - [7.3 配置层级](#73-配置层级)
  - [7.4 沙箱机制](#74-沙箱机制)
- [8. 生态包实战 — Superpowers 深度解析](#8-生态包实战--superpowers-深度解析)
  - [8.1 生态包概述](#81-生态包概述)
  - [8.2 Superpowers 深度解析](#82-superpowers-深度解析)
  - [8.3 其他热门包概览](#83-其他热门包概览)
  - [8.4 选型建议](#84-选型建议)
- [总结](#总结)

## 1. 全局架构 — Claude Code 的分层设计
...
Agent 引擎的核心是 Agent Loop：思考（Think）、行动（Act）、观察（Observe）。用户发出一条指令后，引擎在多轮循环中逐步推进——每一轮都可能调用工具、读取文件、执行命令，直到任务完成。
